...
var DemoSlider = /*#__PURE__*/ function() {
    function DemoSlider1(parent) {
        ...
        _defineProperty2["default"](this, "handleOnChange", function() {
            _this.updatePanel();
        });
        _defineProperty2["default"](this, "handleInputChange", function() {
            _this.options = {
                limits: {
                    min: _this.minValueInstance.getValue(),
                    max: _this.maxValueInstance.getValue()
                },
                step: _this.stepInstance.getValue(),
                showValueNote: _this.noteValueInstance.isChecked(),
                vertical: _this.verticalInstance.isChecked(),
                "double": _this.doubleInstance.isChecked(),
                from: _this.fromInstance.getValue(),
                to: _this.doubleInstance.isChecked() ? _this.toInstance.getValue() : _this.currentValueInstance.getValue(),
                onChange: _this.options.onChange
            };
            $('.js-demo-slider__adslider', _this.parent).adslider('update', _this.options);
            _this.updatePanel();
        });
        this.parent = parent;
        this.init();
    ...
    _createClass2["default"](DemoSlider1, [
        {
            ...
            value: function init() {
                ...
                if (minValueElement) {
                    this.minValueInstance = new _Input["default"](minValueElement, this.handleInputChange);
                    this.inputsArray.push(this.minValueInstance.getInputElement());
                }
                if (maxValueElement) {
                    this.maxValueInstance = new _Input["default"](maxValueElement, this.handleInputChange);
                    this.inputsArray.push(this.maxValueInstance.getInputElement());
                }
                if (currentValueElement) {
                    this.currentValueInstance = new _Input["default"](currentValueElement, this.handleInputChange);
                    this.inputsArray.push(this.currentValueInstance.getInputElement());
                }
                if (stepElement) {
                    this.stepInstance = new _Input["default"](stepElement, this.handleInputChange);
                    this.inputsArray.push(this.stepInstance.getInputElement());
                }
                if (fromElement) {
                    this.fromInstance = new _Input["default"](fromElement, this.handleInputChange);
                    this.inputsArray.push(this.fromInstance.getInputElement());
                }
                if (toElement) {
                    this.toInstance = new _Input["default"](toElement, this.handleInputChange);
                    this.inputsArray.push(this.toInstance.getInputElement());
                }
                if (noteValueElement) {
                    this.noteValueInstance = new _Checkbox["default"](noteValueElement, this.handleInputChange);
                    this.inputsArray.push(this.noteValueInstance.getCheckboxElement());
                }
                if (verticalElement) {
                    this.verticalInstance = new _Checkbox["default"](verticalElement, this.handleInputChange);
                    this.inputsArray.push(this.verticalInstance.getCheckboxElement());
                }
                if (doubleElement) {
                    this.doubleInstance = new _Checkbox["default"](doubleElement, this.handleInputChange);
...
var Input = /*#__PURE__*/ function() {
    function Input1(parent, handleOnChange) {
    ...
    _createClass2["default"](Input1, [
        {
            key: "init",
            value: function init(handleOnChange) {
...
var Checkbox = /*#__PURE__*/ function() {
    function Checkbox1(parent, handleOnChange) {
